...
bool fill_in_airport_metadata_defaults(WED_Airport& airport, const CSVParser::CSVTable& table)
{
    ...
    if (found_data)
    {
        ...
        for (i = 1; i < default_values.size(); i++)
        {
            ...
            if (key_enum > wed_AddMetaDataBegin &&
                key_enum < wed_AddMetaDataEnd) // We *only* want to insert keys we recognize
            {
...
bool add_iso3166_country_metadata(WED_Airport& apt, bool inProgress)
{
    ...
    if (!has_iso)
    {
        ...
        if (country.size())
        {
            ...
            std::transform(country_l.begin(), country_l.end(), country_l.begin(),
        ...
        if (matches == 0)
        {
            ...
            if (ICAO_code.size()) // trust explicit std::set and plausibility checked ICAO meta adata
            {
                ...
                if (ICAO_code[0] == 'K')
                    code3 = "USA ";
                else if (ICAO_code[0] == 'C')
                    code3 = "CAN ";
                else if (ICAO_code[0] == 'E')
                {
                    if (ICAO_code[1] == 'D')
                        code3 = "DEU ";
                    else if (ICAO_code[1] == 'G')
                        code3 = "GBR ";
                    else if (ICAO_code[1] == 'S')
                        code3 = "SWE ";
                    else if (ICAO_code[1] == 'N')
                        code3 = "NOR ";
                    else if (ICAO_code[1] == 'K')
                        code3 = "DAN ";
                    else if (ICAO_code[1] == 'P')
                        code3 = "POL ";
                }
                else if (ICAO_code[0] == 'L')
                {
                    if (ICAO_code[1] == 'F')
                        code3 = "FRA ";
                    else if (ICAO_code[1] == 'E')
                        code3 = "ESP ";
                    else if (ICAO_code[1] == 'O')
                        code3 = "AUT ";
                    else if (ICAO_code[1] == 'I')
                        code3 = "ITA ";
                    else if (ICAO_code[1] == 'S')
                        code3 = "CHE ";
                    else if (ICAO_code[1] == 'K')
                        code3 = "SWI ";
                    else if (ICAO_code[1] == 'C')
                        code3 = "CYP ";
                    else if (ICAO_code[1] == 'P')
                        code3 = "PRT ";
                    else if (ICAO_code[1] == 'T')
                        code3 = "TUR ";
                }
                else if (ICAO_code[0] == 'Y')
                    code3 = "AUS ";
                ...
                else if (ICAO_code == "FA")
                    code3 = "ZAF ";
                else if (ICAO_code == "GV")
                    code3 = "CPV ";
                else if (ICAO_code == "MG")
                    code3 = "GTM ";
                else if (ICAO_code == "SA")
                    code3 = "ARG ";
                else if (ICAO_code == "SB" || ICAO_code == "SD" || ICAO_code == "SI" || ICAO_code == "SJ" ||
                         ICAO_code == "SN" || ICAO_code == "SW")
                    code3 = "BRA ";
                else if (ICAO_code == "SP")
                    code3 = "PER ";
                else if (ICAO_code == "VY")
                    code3 = "MMR ";
                else if (ICAO_code[0] == 'U' && ICAO_code[1] > 'D' && ICAO_code[1] != 'G' && ICAO_code[1] != 'K' &&
                         ICAO_code[1] != 'M' && ICAO_code[1] != 'T')
                    code3 = "RUS ";
                else if (ICAO_code == "WA" || ICAO_code == "WI" || ICAO_code == "WQ" || ICAO_code == "WR")
                    code3 = "IDN ";
