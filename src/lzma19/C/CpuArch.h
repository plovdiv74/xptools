...
#if defined(MY_CPU_X86_OR_AMD64) || defined(MY_CPU_ARM_LE) || defined(MY_CPU_ARM64_LE) || defined(MY_CPU_IA64_LE) ||   \
...
#define MY_CPU_LE
    ...
    defined(__MIPSEB__) || defined(__MIPSEB) || defined(_MIPSEB) || defined(__m68k__) || defined(__s390__) ||          \
    defined(__s390x__) || defined(__zarch__) || (defined(__BYTE_ORDER__) && (__BYTE_ORDER__ == __ORDER_BIG_ENDIAN__))
#define MY_CPU_BE
#endif
...
#ifdef MY_CPU_LE
#if defined(MY_CPU_X86_OR_AMD64) || defined(MY_CPU_ARM64) || defined(__ARM_FEATURE_UNALIGNED)
