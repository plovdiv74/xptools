...
static const glyph_tex_info k_tex_syms[] = {
    glyph_0,         sign_color_black,       0,  0,  1, glyph_1,         sign_color_black,       1,  0,  1,
    glyph_2,         sign_color_black,       2,  0,  1, glyph_3,         sign_color_black,       3,  0,  1,
    glyph_4,         sign_color_black,       4,  0,  1, glyph_5,         sign_color_black,       5,  0,  1,
    glyph_6,         sign_color_black,       6,  0,  1, glyph_7,         sign_color_black,       7,  0,  1,
    glyph_8,         sign_color_black,       8,  0,  1, glyph_9,         sign_color_black,       9,  0,  1,
    glyph_hazard,    sign_color_independent, 10, 0,  2, glyph_safety,    sign_color_independent, 12, 0,  2,
    glyph_critical,  sign_color_independent, 14, 0,  2,

    glyph_0,         sign_color_location,    0,  1,  1, glyph_1,         sign_color_location,    1,  1,  1,
    glyph_2,         sign_color_location,    2,  1,  1, glyph_3,         sign_color_location,    3,  1,  1,
    glyph_4,         sign_color_location,    4,  1,  1, glyph_5,         sign_color_location,    5,  1,  1,
    glyph_6,         sign_color_location,    6,  1,  1, glyph_7,         sign_color_location,    7,  1,  1,
    glyph_8,         sign_color_location,    8,  1,  1, glyph_9,         sign_color_location,    9,  1,  1,
    glyph_A,         sign_color_location,    10, 1,  1, glyph_B,         sign_color_location,    11, 1,  1,
    glyph_C,         sign_color_location,    12, 1,  1, glyph_D,         sign_color_location,    13, 1,  1,
    glyph_E,         sign_color_location,    14, 1,  1, glyph_F,         sign_color_location,    15, 1,  1,

    glyph_G,         sign_color_location,    0,  2,  1, glyph_H,         sign_color_location,    1,  2,  1,
    glyph_I,         sign_color_location,    2,  2,  1, glyph_J,         sign_color_location,    3,  2,  1,
    glyph_K,         sign_color_location,    4,  2,  1, glyph_L,         sign_color_location,    5,  2,  1,
    glyph_M,         sign_color_location,    6,  2,  1, glyph_N,         sign_color_location,    7,  2,  1,
    glyph_O,         sign_color_location,    8,  2,  1, glyph_P,         sign_color_location,    9,  2,  1,
    glyph_Q,         sign_color_location,    10, 2,  1, glyph_R,         sign_color_location,    11, 2,  1,
    glyph_S,         sign_color_location,    12, 2,  1, glyph_T,         sign_color_location,    13, 2,  1,
    glyph_U,         sign_color_location,    14, 2,  1, glyph_V,         sign_color_location,    15, 2,  1,

    glyph_W,         sign_color_location,    0,  3,  1, glyph_X,         sign_color_location,    1,  3,  1,
    glyph_Y,         sign_color_location,    2,  3,  1, glyph_Z,         sign_color_location,    3,  3,  1,
    glyph_0,         sign_color_yellow,      4,  3,  1, glyph_1,         sign_color_yellow,      5,  3,  1,
    glyph_2,         sign_color_yellow,      6,  3,  1, glyph_3,         sign_color_yellow,      7,  3,  1,
    glyph_4,         sign_color_yellow,      8,  3,  1, glyph_5,         sign_color_yellow,      9,  3,  1,
    glyph_6,         sign_color_yellow,      10, 3,  1, glyph_7,         sign_color_yellow,      11, 3,  1,
    glyph_8,         sign_color_yellow,      12, 3,  1, glyph_9,         sign_color_yellow,      13, 3,  1,
    glyph_A,         sign_color_yellow,      14, 3,  1, glyph_B,         sign_color_yellow,      15, 3,  1,

    glyph_C,         sign_color_yellow,      0,  4,  1, glyph_D,         sign_color_yellow,      1,  4,  1,
    glyph_E,         sign_color_yellow,      2,  4,  1, glyph_F,         sign_color_yellow,      3,  4,  1,
    glyph_G,         sign_color_yellow,      4,  4,  1, glyph_H,         sign_color_yellow,      5,  4,  1,
    glyph_I,         sign_color_yellow,      6,  4,  1, glyph_J,         sign_color_yellow,      7,  4,  1,
    glyph_K,         sign_color_yellow,      8,  4,  1, glyph_L,         sign_color_yellow,      9,  4,  1,
    glyph_M,         sign_color_yellow,      10, 4,  1, glyph_N,         sign_color_yellow,      11, 4,  1,
    glyph_O,         sign_color_yellow,      12, 4,  1, glyph_P,         sign_color_yellow,      13, 4,  1,
    glyph_Q,         sign_color_yellow,      14, 4,  1, glyph_R,         sign_color_yellow,      15, 4,  1,

    glyph_S,         sign_color_yellow,      0,  5,  1, glyph_T,         sign_color_yellow,      1,  5,  1,
    glyph_U,         sign_color_yellow,      2,  5,  1, glyph_V,         sign_color_yellow,      3,  5,  1,
    glyph_W,         sign_color_yellow,      4,  5,  1, glyph_X,         sign_color_yellow,      5,  5,  1,
    glyph_Y,         sign_color_yellow,      6,  5,  1, glyph_Z,         sign_color_yellow,      7,  5,  1,
    glyph_dash,      sign_color_yellow,      8,  5,  1, glyph_dot,       sign_color_yellow,      9,  5,  1,
    glyph_left,      sign_color_yellow,      10, 5,  1, glyph_right,     sign_color_yellow,      11, 5,  1,
    glyph_up,        sign_color_yellow,      12, 5,  1, glyph_down,      sign_color_yellow,      13, 5,  1,
    glyph_leftdown,  sign_color_yellow,      14, 5,  1, glyph_rightdown, sign_color_yellow,      15, 5,  1,

    glyph_leftup,    sign_color_yellow,      0,  6,  1, glyph_rightup,   sign_color_yellow,      1,  6,  1,
    glyph_period,    sign_color_yellow,      2,  6,  1, glyph_comma,     sign_color_yellow,      3,  6,  1,
    glyph_slash,     sign_color_yellow,      4,  6,  1, glyph_r1,        sign_color_yellow,      5,  6,  1,
    glyph_r2,        sign_color_yellow,      6,  6,  1, glyph_r3,        sign_color_yellow,      7,  6,  1,
    glyph_no_entry,  sign_color_independent, 8,  6,  1, glyph_0,         sign_color_red,         9,  6,  1,
    glyph_1,         sign_color_red,         10, 6,  1, glyph_2,         sign_color_red,         11, 6,  1,
    glyph_3,         sign_color_red,         12, 6,  1, glyph_4,         sign_color_red,         13, 6,  1,
    glyph_5,         sign_color_red,         14, 6,  1, glyph_6,         sign_color_red,         15, 6,  1,

    glyph_7,         sign_color_red,         0,  7,  1, glyph_8,         sign_color_red,         1,  7,  1,
    glyph_9,         sign_color_red,         2,  7,  1, glyph_A,         sign_color_red,         3,  7,  1,
    glyph_B,         sign_color_red,         4,  7,  1, glyph_C,         sign_color_red,         5,  7,  1,
    glyph_D,         sign_color_red,         6,  7,  1, glyph_E,         sign_color_red,         7,  7,  1,
    glyph_F,         sign_color_red,         8,  7,  1, glyph_G,         sign_color_red,         9,  7,  1,
    glyph_H,         sign_color_red,         10, 7,  1, glyph_I,         sign_color_red,         11, 7,  1,
    glyph_J,         sign_color_red,         12, 7,  1, glyph_K,         sign_color_red,         13, 7,  1,
    glyph_L,         sign_color_red,         14, 7,  1, glyph_M,         sign_color_red,         15, 7,  1,

    glyph_N,         sign_color_red,         0,  8,  1, glyph_O,         sign_color_red,         1,  8,  1,
    glyph_P,         sign_color_red,         2,  8,  1, glyph_Q,         sign_color_red,         3,  8,  1,
    glyph_R,         sign_color_red,         4,  8,  1, glyph_S,         sign_color_red,         5,  8,  1,
    glyph_T,         sign_color_red,         6,  8,  1, glyph_U,         sign_color_red,         7,  8,  1,
    glyph_V,         sign_color_red,         8,  8,  1, glyph_W,         sign_color_red,         9,  8,  1,
    glyph_X,         sign_color_red,         10, 8,  1, glyph_Y,         sign_color_red,         11, 8,  1,
    glyph_Z,         sign_color_red,         12, 8,  1, glyph_dash,      sign_color_red,         13, 8,  1,
    glyph_dot,       sign_color_red,         14, 8,  1, glyph_left,      sign_color_red,         15, 8,  1,

    glyph_right,     sign_color_red,         0,  9,  1, glyph_up,        sign_color_red,         1,  9,  1,
    glyph_down,      sign_color_red,         2,  9,  1, glyph_leftdown,  sign_color_red,         3,  9,  1,
    glyph_rightdown, sign_color_red,         4,  9,  1, glyph_leftup,    sign_color_red,         5,  9,  1,
    glyph_rightup,   sign_color_red,         6,  9,  1, glyph_period,    sign_color_red,         7,  9,  1,
    glyph_comma,     sign_color_red,         8,  9,  1, glyph_slash,     sign_color_red,         9,  9,  1,
    glyph_r1,        sign_color_red,         10, 9,  1, glyph_r2,        sign_color_red,         11, 9,  1,
    glyph_r3,        sign_color_red,         12, 9,  1, glyph_space,     sign_color_yellow,      13, 9,  1,
    glyph_space,     sign_color_red,         14, 9,  1, glyph_separator, sign_color_location,    15, 9,  1,

    glyph_separator, sign_color_yellow,      0,  10, 1, glyph_separator, sign_color_red,         1,  10, 1};
...
const glyph_tex_info* lookup_glyph(parser_glyph_t g, parser_color_t c)
{
    for (int i = 0; i < k_tex_syms_size; ++i)
        if (k_tex_syms[i].glyph == g && k_tex_syms[i].color == c)
            return k_tex_syms + i;
    return NULL;
}
...
{
    if (glyph == glyph_critical || glyph == glyph_safety || glyph == glyph_hazard)
        return 64;
...
bool sign_data::from_code(const std::string& code)
{
    ...
    ::transform(output.out_sign.front.begin(), output.out_sign.front.end(), back_inserter(front), make_from_parser);

    ::transform(output.out_sign.back.begin(), output.out_sign.back.end(), back_inserter(back), make_from_parser);
...
WED_Sign_Editor::WED_Sign_Editor(GUI_Commander* parent)
    : GUI_EditorInsert(parent), mEditSide(0), mEditStart(0), mEditEnd(0), mCaret(1), mColor(sign_color_yellow)
{
...
void WED_Sign_Editor::Draw(GUI_GraphState* state)
{
    ...
    parser_color_t colors[8] = {sign_color_yellow, sign_color_yellow, sign_color_location, sign_color_location,
                                sign_color_red,    sign_color_red,    sign_color_black,    sign_color_independent};
...
void WED_Sign_Editor::replace_selection(parser_glyph_t g, parser_color_t c)
{
    ...
    if (g == glyph_separator) // check for various cases where we don't allow a separator to be placed
    {
        ...
        if (side[low - 1].color != c)
            return;
        if (side[low - 1].color != sign_color_red && side[low - 1].color != sign_color_yellow &&
...
void WED_Sign_Editor::selection_changed()
{
    ...
    if (mEditEnd < 0)
        mEditEnd = 0;
    if (mEditStart > side.size())
        mEditStart = side.size();
...
void RenderSign(GUI_GraphState* state, int x, int y, const std::string& sign_text, float scale, int font_id,
                const float color[4])
{
    sign_data sign;
