...
WED_TruckParkingLocation::WED_TruckParkingLocation(WED_Archive* a, int i)
    : WED_GISPoint_Heading(a, i), truck_type(this, PROP_Name("Truck Type", XML_Name("truck_parking_spot", "type")),
                                             ATCServiceTruckType, apt_truck_fuel_prop),
...
void WED_TruckParkingLocation::SetTruckType(int truckType)
{
    truck_type = truckType;
}
int WED_TruckParkingLocation::GetTruckType(void) const
{
    return truck_type.value;
}
std::string WED_TruckParkingLocation::GetTruckCustom(void) const
{
    return custom_vehicle.value;
}

void WED_TruckParkingLocation::SetNumberOfCars(int numberOfCars)
{
    number_of_cars = numberOfCars;
}
int WED_TruckParkingLocation::GetNumberOfCars(void) const
{
    return number_of_cars.value;
}

void WED_TruckParkingLocation::Import(const AptTruckParking_t& x, void (*print_func)(void*, const char*, ...),
                                      void* ref)
{
